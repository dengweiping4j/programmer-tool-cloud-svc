...
public class DataConnectionController {
    ...
    public ResponseEntity<PaginationSuccessDTO<DataConnectionDTO>> query(@RequestBody DataConnectionDTO queryBuilder,
